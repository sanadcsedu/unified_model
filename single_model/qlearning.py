...
if __name__ == "__main__":
    ...
    for d in datasets:
        ...
        for i, test_user_log in enumerate((user_list)):
            ...
            trained_Q, best_alpha, best_eps, best_discount, training_accuracy = training(d, train_files, 5, 'Qlearn')
            X_train.append(training_accuracy)
            # test user
            test_files = [test_user_log]
            testing_accu, gp = testing(d, test_files, trained_Q, best_alpha, best_eps, best_discount, 'Qlearn')
