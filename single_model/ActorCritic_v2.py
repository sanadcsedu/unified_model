...
class ActorCritic(nn.Module):
    ...
    def train_net(self):
        ...
        loss = -torch.log(pi_a) * delta.detach() + F.mse_loss(self.v(s), td_target.detach())
        # pdb.set_trace()
        # print(loss)
...
class Agent():
    def __init__(self, env,learning_rate,gamma,num_rollouts=2):
        self.env = env
        ...
        for _ in range(5):
            ...
            while not done:
                for t in range(self.n_rollout):
                    ...
                    model.put_data((s, ground_action, 1, s_prime, done))
    ...
    def test(self,model):
        ...
        for _ in range(10):
            ...
            for t in itertools.count():
                ...
                model.put_data((s, a, r, s_prime, done))
                model.put_data((s, ground_action, 10, s_prime, done))
...
def training(dataset, train_files, epoch, algorithm):
    ...
    for lr in learning_rates:
        for ga in gammas:
            ...
            # print(lr, ga, "Training Accuracy ", accu_model)
...
if __name__ == '__main__':
    ...
    for d in datasets:
        ...
        for i, test_user_log in enumerate((user_list)):
            ...
            print("User ", get_user_name(test_user_log), "Testing Accuracy ",  round(testing_accu, 2))
