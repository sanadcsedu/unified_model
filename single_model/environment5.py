# This version of the environment is for leave-one-out-cross validation. So, there is no threshold. Rather read everything into main memory.
import os
import fnmatch
import pdb
...
class environment5:
    ...
    def process_data(self, task, raw_file, feedback_file, algo):
        # pdb.set_trace()
        obj = read_data()
